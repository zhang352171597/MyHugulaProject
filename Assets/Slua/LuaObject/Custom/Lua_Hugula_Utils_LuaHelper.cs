...
public class Lua_Hugula_Utils_LuaHelper : LuaObject {
	...
	static public int InstantiateLocal_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function InstantiateLocal to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int RefreshShader_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function RefreshShader to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int PlayAnimation_s(IntPtr l) {
		try {
			...
			a3 = (AnimationDirection)LuaDLL.luaL_checkinteger(l, 3);
