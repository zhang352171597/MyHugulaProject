...
public class Lua_Hugula_UI_MessageBox : LuaObject {
	...
	[UnityEngine.Scripting.Preserve]
	static public int ShowContent(IntPtr l) {
		try {
			#if DEBUG
			...
			if(argc==4){
				...
				self.ShowContent(a1,a2,a3,a4,a5,a6);
				pushValue(l,true);
				return 1;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function ShowContent to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
