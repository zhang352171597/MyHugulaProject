	...
	public class BindCustom {
		public static Action<IntPtr>[] GetBindList() {
			Action<IntPtr>[] list= {
				...
				Lua_System_Net_WebHeaderCollection.reg,
			};
			return list;
		}
	}
