...
public class Lua_Hugula_Loader_ResourcesLoader : LuaObject {
	...
	static public int LoadAsset_s(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				checkType(l,1,out a1);
				Hugula.Loader.ResourcesLoader.LoadAsset(a1);
				pushValue(l,true);
				return 1;
			}
			else if(argc==6){
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int UnityWebRequestCoroutine_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Type a3;
			checkType(l,3,out a3);
			var ret=Hugula.Loader.ResourcesLoader.UnityWebRequestCoroutine(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int UnityWebRequest_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(argc==1){
				Hugula.Loader.CRequest a1;
				checkType(l,1,out a1);
				Hugula.Loader.ResourcesLoader.UnityWebRequest(a1);
				pushValue(l,true);
				return 1;
			}
			else if(argc==5){
				...
				System.Action<Hugula.Loader.CRequest> a5;
				checkDelegate(l,5,out a5);
				Hugula.Loader.ResourcesLoader.UnityWebRequest(a1,a2,a3,a4,a5);
				pushValue(l,true);
				return 1;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function UnityWebRequest to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int WWWRequest_s(IntPtr l) {
		try {
			...
			Hugula.Loader.CRequest a1;
			checkType(l,1,out a1);
			Hugula.Loader.ResourcesLoader.WWWRequest(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int HttpWebRequestCoroutine_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Type a3;
			checkType(l,3,out a3);
			var ret=Hugula.Loader.ResourcesLoader.HttpWebRequestCoroutine(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int HttpWebRequest_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(argc==1){
				Hugula.Loader.CRequest a1;
				checkType(l,1,out a1);
				Hugula.Loader.ResourcesLoader.HttpWebRequest(a1);
				pushValue(l,true);
				return 1;
			}
			else if(argc==5){
				...
				System.Action<Hugula.Loader.CRequest> a5;
				checkDelegate(l,5,out a5);
				Hugula.Loader.ResourcesLoader.HttpWebRequest(a1,a2,a3,a4,a5);
				pushValue(l,true);
				return 1;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function HttpWebRequest to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int RegisterOverrideBaseAssetbundleURL_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			#endif
			Hugula.Loader.ResourcesLoader.OverrideBaseDownloadingURLDelegate a1;
			checkDelegate(l,1,out a1);
			Hugula.Loader.ResourcesLoader.RegisterOverrideBaseAssetbundleURL(a1);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,UnityWebRequestCoroutine_s);
		addMember(l,UnityWebRequest_s);
		addMember(l,WWWRequest_s);
		addMember(l,HttpWebRequestCoroutine_s);
		addMember(l,HttpWebRequest_s);
		addMember(l,RegisterOverrideBaseAssetbundleURL_s);
