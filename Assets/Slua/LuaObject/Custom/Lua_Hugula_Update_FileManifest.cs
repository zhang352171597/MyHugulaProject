...
public class Lua_Hugula_Update_FileManifest : LuaObject {
	...
	static public int AppendFileManifest(IntPtr l) {
		try {
			...
			checkType(l,2,out a1);
			var ret=self.AppendFileManifest(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_newAppNumVersion(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			Hugula.Update.FileManifest self=(Hugula.Update.FileManifest)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.newAppNumVersion);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_newAppNumVersion(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"newAppNumVersion",get_newAppNumVersion,set_newAppNumVersion,true);
