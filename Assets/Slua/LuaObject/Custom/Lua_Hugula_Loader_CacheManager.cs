...
public class Lua_Hugula_Loader_CacheManager : LuaObject {
	...
	static public int ClearDelay_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function ClearDelay to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int UnloadCacheFalse_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function UnloadCacheFalse to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int UnloadDependenciesCacheFalse_s(IntPtr l) {
		try {
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function UnloadDependenciesCacheFalse to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
