...
public class Lua_Hugula_Loader_LoadingEventArg : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				o=new Hugula.Loader.LoadingEventArg(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(Hugula.Loader.LoadingEventArg),typeof(System.ComponentModel.ProgressChangedEventArgs));
	}
}
