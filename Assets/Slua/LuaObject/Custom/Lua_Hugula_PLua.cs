...
public class Lua_Hugula_PLua : LuaObject {
	...
	[UnityEngine.Scripting.Preserve]
	static public int PreInitLua(IntPtr l) {
		try {
			#if DEBUG
	...
	static public int MultipleRequires_s(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				Hugula.PLua.MultipleRequires(a1);
				pushValue(l,true);
				return 1;
			}
			else if(argc==2){
				...
				Hugula.PLua.MultipleRequires(a1,a2);
				pushValue(l,true);
				return 1;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function MultipleRequires to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_coroutine(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.PLua.coroutine);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"coroutine",get_coroutine,null,false);
