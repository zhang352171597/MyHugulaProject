...
public class Lua_Hugula_Loader_ManifestManager : LuaObject {
	...
	[UnityEngine.Scripting.Preserve]
	static public int CheckIsUpdateFile_s(IntPtr l) {
		try {
			#if DEBUG
			...
			var ret=Hugula.Loader.ManifestManager.CheckIsUpdateFile(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SetUpdateFileManifest_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkType(l,1,out a1);
			var ret=Hugula.Loader.ManifestManager.SetUpdateFileManifest(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int LoadUpdateFileManifest_s(IntPtr l) {
		try {
			...
			var ret=Hugula.Loader.ManifestManager.LoadUpdateFileManifest(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_localVersion(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.ManifestManager.localVersion);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_needClearCache(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.ManifestManager.needClearCache);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,CheckIsUpdateFile_s);
		addMember(l,CheckABIsDone_s);
		addMember(l,CheckIsInFileManifest_s);
		addMember(l,SetUpdateFileManifest_s);
		...
		addMember(l,"localVersion",get_localVersion,null,false);
		addMember(l,"needClearCache",get_needClearCache,null,false);
