...
public class Lua_Hugula_Loader_LoaderType : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			Hugula.Loader.LoaderType o;
			o=new Hugula.Loader.LoaderType();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_Typeof_String(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_String);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_Bytes(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_Bytes);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_AssetBundle(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_AssetBundle);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_ABScene(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_ABScene);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_ABAllAssets(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_ABAllAssets);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_AudioClip(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_AudioClip);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_Texture2D(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_Texture2D);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_Typeof_Object(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,Hugula.Loader.LoaderType.Typeof_Object);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Hugula.Loader.LoaderType");
		...
		createTypeMetatable(l,constructor, typeof(Hugula.Loader.LoaderType));
	}
}
